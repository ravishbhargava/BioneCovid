...
public class Question4SymptomsFragment extends Fragment {
    ...
    private void initRecycler(final View view) {
        ...
        Slots slots1 = new Slots("Dry Cough", false);
        Slots slots2 = new Slots("Sore Throat", false);
        Slots slots3 = new Slots("Weakness", false);
        Slots slots4 = new Slots("Body Pain", false);
        Slots slots5 = new Slots("None of these", false);
